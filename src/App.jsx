...
function App() {
    return (
        <div style={{display:'flex',flexWrap:'wrap',justifyContent:'center'}}>
            ...
            <Profile name="Marylin Monoroe" description="she was an American actress and model." image={images.marilyn}/>
            <Profile name="Cilian Murphy" description="Irish actor known for his intense performances." image={images.cilian}/>
            <Profile name="Maryam Mirzakhani" description="Maryam Mirzakhani was an Iranian mathematician and a professor of mathematics." image={images.maryam}/>
